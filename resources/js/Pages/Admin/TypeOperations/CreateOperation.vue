<template>
    <div class="modal fade said" id="AddOperation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        style="display: none;" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form @submit.prevent="submit">
                    <div class="modal-header bg-secondary">
                        <h5 class="modal-title text-white" id="exampleModalLabel">Ajouter Operation</h5>
                        ...
                        <div class="iq-card-body">
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" v-model="operation.typeOperation"
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn mb-3 btn-primary"><i class="ri-bill-fill"
                                :disabled="operation.processing"></i>Ajouter</button>
                    </div>
                </form>
            </div>
