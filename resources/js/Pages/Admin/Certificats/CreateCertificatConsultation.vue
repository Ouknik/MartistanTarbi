...
<template>
    <div class="modal fade" id="AddCertificatConsultation" tabindex="-1" role="dialog" style="display: none;"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form @submit.prevent="submit">
                    <div class="modal-header bg-secondary">
                        <h5 class="modal-title text-white">Ajouter Certificat Consultation
                        </h5>
...
const form = useForm({
    ...
    typeCertificat: "Certificat Consultation",
...
watchEffect(() => {
    form.contenu = `Je soussigné Dr.${props.docteur.name} que ${props.patient.civilitePatient} ${props.patient.nomPatient} ${props.patient.prenomPatient}. C'est présente aujourd'hui à la consultation.\n Ce Certificat délivré à l'intéressée pour servir et valoir ce que de droit.`;
});


// form.contenu = contenuComputed;
...
const submit = () => {
    ...
    router.visit('/certificats', {
        ...
        onSuccess: page => {
            ...
            $('#AddCertificatConsultation').modal('hide');
        },
