...
<template>
    <div class="modal fade" id="AddCertificatRepos" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form @submit.prevent="submit">
                    <div class="modal-header bg-secondary">
                        <h5 class="modal-title text-white">Ajouter Certificat Repos
                        </h5>
...
const form = useForm({
    typeCertificat: "Certificat Repos",
    contenu: "",
...
// Use watchEffect to update the 'contenu' field
watchEffect(() => {
    form.contenu = `Je soussigné Dr.${props.docteur.name}, certifie \n Que ${props.patient.civilitePatient} ${props.patient.prenomPatient} ${props.patient.nomPatient} nécessite un repos  de travail. \nDe () jours à compter du ${today}. \n Ce Certificat est délivré pour servir et valoir ce que de droit.`;
});
const submit = () => {
    let dataToSend = { ...form };
