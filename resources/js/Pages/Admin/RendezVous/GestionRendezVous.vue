<template>
    <div class="modal fade bd-GestionRendezVous-modal-lg" tabindex="-1" role="dialog" ref="GestionRendezVousModal"
        id="ModalAddRendezVous">
            ...
            <div class="modal-content" style="background-color: #eff7f8 ;">
                ...
                <div class="modal-body">
                    <ul class="nav nav-pills nav-fill mb-3" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="patientAddRendeVous-tab" data-toggle="pill"
                                href="#patientAddRendeVous" role="tab" aria-controls="patientAddRendeVous"
                                aria-selected="true"><i class="fas fa-file-invoice"></i>Ajouter Rendez-Vous</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " id="patientRendezVousList-tab" data-toggle="pill"
                                href="#patientRendezVousList" role="tab" aria-controls="patientRendezVousList"
                                aria-selected="false"><i class="fas fa-hand-holding-usd"></i>Liste Des Rendez-Vous</a>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade " id="patientRendezVousList" role="tabpanel"
                            aria-labelledby="patientRendezVousList-tab" v-if="currentPatient">
                            <div class="iq-card">
                                <div class="iq-card-body">
                                    <div class="table-responsive">
                                        <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <tr v-for="rendezVous in currentPatient.rendez_vous" v-bind:key="rendezVous.id">
                        ...
                        <div class="tab-pane fade  show active" id="patientAddRendeVous" role="tabpanel"
                            aria-labelledby="patientAddRendeVous-tab" v-if="currentPatient">
                            ...
                            <div class="form-group col-md-4 col-lg-12">
                                <label class="control-label align-self-center mb-1" for="DocteurAddRendezVous"><span
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" style="font-size: 16px;" class="btn btn-secondary"
                        @click="CloseGestionRendezVousModal" data-dismiss="modal">
                        Fermer
                    </button>
                </div>
            </div>
...
const GestionRendezVousModal = ref(null);
...
const CloseGestionRendezVousModal = () => {
    props.currentPatient = null;
};
