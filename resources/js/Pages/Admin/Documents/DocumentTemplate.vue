<template>
    <div class="main">
        ...
        <!-- Document editor -->
        <vue-document-editor class="editor" ref="editor" v-model:content="content" :zoom="zoom"
            :page_format_mm="page_format_mm" :page_margins="page_margins" :display="display" />
        <invoice-template v-if="showInvoiceTemplate" :modelValue="invoiceData" ref="invoiceTemplate" />
        <!-- <invoice-template v-if="showInvoiceTemplate" :modelValue="invoice_number" ref="invoiceTemplate" /> -->
...
export default {
    props: {
        ordonnanceData: Object
    },
    components: { VueDocumentEditor, VueFileToolbarMenu, InvoiceTemplate },
    ...
    data() {
        return {
            ...
            content: [
                ...
                { template: markRaw(InvoiceTemplate), props: { dataord: this.$props.ordonnanceData } },
            ...
            showInvoiceTemplate: false, // Set this flag to show/hide the InvoiceTemplate component
            invoiceData: null,
        }
    },
    ...
    computed: {
        ...
        menu() {
            return [
                // Main commands
                { text: "Imprimer", title: "Print", icon: "print", click: this.printInvoice },
    ...
    methods: {
        ...
        printInvoice() {
            this.invoiceData = { dataord: this.$props.ordonnanceData };
            this.showInvoiceTemplate = true;
            this.$nextTick(() => {
                // Call the printInvoice method of the InvoiceTemplate component
                this.$refs.invoiceTemplate.printInvoice();

                // Hide the InvoiceTemplate component after printing (if needed)
